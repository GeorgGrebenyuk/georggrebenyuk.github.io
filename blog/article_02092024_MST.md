...
* перечень всех открытых Документов в приложении INanoCADDocuments (nanoCAD) или AcadDocuments (AutoCAD);

`application.Documents`

- перечень всех Ссылок в свойствах объекта `AcadHyperlinks`;

`object.Hyperlinks`

- перечень всех именоанных наборов выбранных объектов `AcadSelectionSets`;
